 ...
 * Frontend API types.
 *
 * NOTE: Canonical domain types now live in @embeddr/client-typescript/embeddr-api-types.
...
export type {
  ...
  ErrorResponse,
  ErrorCode,
} from "@embeddr/client-typescript/embeddr-api-types";
...
export interface ArtifactRegistryResponse {
  ...
  storage_backends: Array<string>;
  type_names: Array<string>;
  base_type_names: Array<string>;
  import_sources: Array<string>;
  import_instances: Array<string>;
...
export interface RelationOntologyResponse {
  families: Record<string, Array<string>>;
  types: Array<RelationTypeDefResponse>;
  structural_parent_to_child: Array<string>;
  structural_child_to_parent: Array<string>;
  structural_all: Array<string>;
}
...
export interface LineageResponse {
  parents: Array<ArtifactLineage>;
  children: Array<ArtifactLineage>;
}
...
export interface ArtifactGraphQueryResponse {
  nodes: Array<ArtifactGraphNode>;
  edges: Array<ArtifactGraphEdge>;
  meta: {
    truncated?: boolean;
...
export interface Execution {
  ...
  type: string;
  plugin_name: string;
  status: "pending" | "running" | "completed" | "failed" | "canceled" | "waiting";
  priority: number;
  progress: number;
  message?: string;
  trigger?: string;
...
export interface ProvenanceResponse {
  ...
  inputs: Array<ProvenanceStep>;
  outputs: Array<ProvenanceStep>;
  relations: Array<ProvenanceStep>;
  annotations: Array<ProvenanceAnnotation>;
}
