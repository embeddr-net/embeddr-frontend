...
export async function fetchActionArtifacts(): Promise<Array<Artifact>> {
...
export interface AvailableAction {
  ...
  description: string;
  version: string;
  inputs: Record<string, any> | Array<string>;
  outputs: Record<string, any> | Array<string>;
}

export async function fetchAvailableActions(): Promise<Array<AvailableAction>> {
