...
export const getArtifactImportSource = (artifact: { metadata_json?: Record<string, any> }) => {
  return artifact.metadata_json?.external?.source || null;
};

export const getArtifactOrigin = (artifact: { metadata_json?: Record<string, any> }) => {
  return artifact.metadata_json?.origin || artifact.metadata_json?.comfy_meta?.origin || null;
};
