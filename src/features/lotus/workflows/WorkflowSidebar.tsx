        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <DropdownMenuItem onClick={() => onCreate("empty")}>Empty workflow</DropdownMenuItem>
              <DropdownMenuSeparator />
        ...
        <ScrollArea className="h-full">
          <div className="flex flex-col gap-2">
              ...
              <div key={workflow.id} className="flex items-center gap-2">
                ...
                >
                  <div className="flex flex-col">
                    <span className="text-xs font-medium">{workflow.metadata_json.name}</span>
            ...
            {!isLoading && workflows && workflows.length === 0 && (
              <div className="text-xs text-muted-foreground">No workflows found.</div>
            )}
          </div>
        </ScrollArea>
      </CardContent>
