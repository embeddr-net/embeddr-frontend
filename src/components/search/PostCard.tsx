  ...
  ({
    ...
    const imageUrl =
      useOriginalImages && post.media_type !== "video"
        ...
        : post.thumb_url || embeddrApi.artifacts.getPreviewUrl(post.id, "thumbnail");
        ...
        <ContextMenuTrigger>
          <div
            ...
            onDragStart={(e) => {
              ...
              const previewUrl = embeddrApi.artifacts.getPreviewUrl(post.id, "thumbnail");
              ...
              // Standardized Tags
              e.dataTransfer.setData(EmbeddrDnDTypes.ARTIFACT_ID, post.id.toString());
              // Legacy/Compat
              e.dataTransfer.setData(EmbeddrDnDTypes.IMAGE_ID, post.id.toString());

              e.dataTransfer.setData(EmbeddrDnDTypes.ARTIFACT_PATH, (post as any).path || "");

              e.dataTransfer.setData(EmbeddrDnDTypes.ARTIFACT_TYPE, post.media_type || "image");
          ...
          >
            <div className="relative overflow-hidden aspect-square">
                ...
                <div className="w-full h-full flex items-center justify-center bg-muted">
                  ...
                  {post.thumb_url ? (
                    <img
                      src={post.thumb_url}
                      alt={post.prompt}
                      className={cn("z-40 w-full h-full duration-300 object-contain")}
                    />
                  ) : (
              ...
              {(post as any).storage_backend && (post as any).storage_backend !== "local" && (
