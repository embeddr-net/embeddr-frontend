...
// export function ZenDatasetPanel({
//   isOpen: propIsOpen,
//   onClose: propOnClose,
// }: ZenDatasetPanelProps) {
//   const { windows, minimizeWindow } = useWindowStore()
//   const windowState = windows['zen-datasets']
//   const isOpen = propIsOpen ?? (windowState ? !windowState.isMinimized : false)
//   const onClose = propOnClose ?? (() => minimizeWindow('zen-datasets'))
...
//                     key={dataset.id}
//                     className={cn(
//                       'group/dataset-item flex items-center justify-between p-2 cursor-pointer hover:bg-accent/50 transition-colors  border border-transparent',
