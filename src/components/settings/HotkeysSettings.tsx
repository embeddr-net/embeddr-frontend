...
import { checkHotkey, formatForDisplay } from "@tanstack/react-hotkeys";
import { Badge, Button } from "@embeddr/react-ui/ui";
import { toast } from "sonner";
import type { Hotkey } from "@tanstack/react-hotkeys";
import type { HotkeyActionId, HotkeyOverrides } from "@/lib/hotkeys/registry";
...
export function HotkeysSettings() {
  const [recordingActionId, setRecordingActionId] = React.useState<HotkeyActionId | null>(null);
