          ...
          <CardTitle className="text-lg flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={JSON.stringify(localConfig) === JSON.stringify(data.config)}
              >
              ...
              <Button
                ...
                disabled={
                  mutation.isPending || JSON.stringify(localConfig) === JSON.stringify(data.config)
                }
              >
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-0.5">
                <Label className="text-sm font-medium">{item.label || key}</Label>
                {item.description && (
...
export function PluginSettings() {
  const { data: plugins, isLoading } = useQuery<Array<any>>({
