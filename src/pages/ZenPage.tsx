...
const ZenPage = () => {
  ...
  const [leftSidebarOpen, setLeftSidebarOpen] = useLocalStorage("create-left-sidebar", false);
  const [rightSidebarOpen, setRightSidebarOpen] = useLocalStorage("create-right-sidebar", false);
